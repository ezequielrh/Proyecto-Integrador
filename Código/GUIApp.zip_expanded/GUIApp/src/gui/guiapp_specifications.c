...
GX_PROMPT_PROPERTIES window1_prompt_6_properties =
{
...
GX_PROMPT_PROPERTIES window1_prompt_7_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_7_define =
{
    "prompt_7",
    ...
    {-1, 169, 254, 192},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_prompt_7), /* control block        */
    (void *) &window1_prompt_7_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window1_prompt_6_define =
{
    "prompt_6",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {-1, 149, 254, 172},                     /* widget size                    */
    &window1_prompt_7_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_prompt_6), /* control block        */
    (void *) &window1_prompt_6_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_prompt_5_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {-1, 61, 254, 84},                       /* widget size                    */
    &window1_prompt_6_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window1_define =
{
    ...
    {-1, 1, 254, 320},                       /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window1_prompt_5_define,                /* child widget                   */
    0,                                       /* control block                  */
...
GX_PROMPT_PROPERTIES window3_PR_INFO_DUTY_CYCLE_properties =
{
    ...
    GX_FONT_ID_REGISTER,                     /* font id                        */
    GX_COLOR_ID_BLUE_SYSTEM,                 /* normal text color              */
    GX_COLOR_ID_BLUE_SYSTEM                  /* selected text color            */
};
GX_PROMPT_PROPERTIES window3_PR_INFO_SET_POINT_properties =
{
    ...
    GX_FONT_ID_REGISTER,                     /* font id                        */
    GX_COLOR_ID_BLUE_SYSTEM,                 /* normal text color              */
    GX_COLOR_ID_NEW_COLOR                    /* selected text color            */
};
...
GX_PROMPT_PROPERTIES window3_Project_properties =
{
...
GX_PROMPT_PROPERTIES window3_Project_dato_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window3_Project_dato_define =
{
    "Project_dato",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {-1, 30, 254, 53},                       /* widget size                    */
    &window3_prompt_2_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_Project_dato), /* control block    */
    (void *) &window3_Project_dato_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window3_Project_define =
{
    "Project",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {-1, 10, 254, 33},                       /* widget size                    */
    &window3_Project_dato_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW3_CONTROL_BLOCK, window3_Project), /* control block         */
    (void *) &window3_Project_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window3_PR_SPEED_define =
{
    ...
    GX_COLOR_ID_SLIDER_NEEDLE_OUTLINE,       /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    gx_studio_numeric_prompt_create,         /* create function                */
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 160, 255, 183},                      /* widget size                    */
    &window3_Project_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
